#include"Level2.h"
Level2::Level2(string backgroundPath, int noOfZombies, int noOfWaves, int allowedPlants, int noOflanes, int allowedZombies):Level(backgroundPath, noOfZombies, noOfWaves, allowedPlants, true, noOflanes, allowedZombies){
...
int Level2::handleInput(Event e, RenderWindow& window){
    if(GameOver){
        return -1;
    }
