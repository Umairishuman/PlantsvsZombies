#include"Level3.h"
Level3::Level3(string backgroundPath, int noOfZombies, int noOfWaves, int allowedPlants, int noOflanes, int allowedZombies):Level(backgroundPath, noOfZombies, noOfWaves, allowedPlants, true, noOflanes, allowedZombies){
...
int Level3::handleInput(Event e, RenderWindow& window){
    if(GameOver){
        return -1;
    }
