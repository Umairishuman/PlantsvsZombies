#include"Level4.h"
Level4::Level4(string backgroundPath, int noOfZombies, int noOfWaves, int allowedPlants, int noOflanes, int allowedZombies):Level(backgroundPath, noOfZombies, noOfWaves, allowedPlants, true, noOflanes, allowedZombies){
...
int Level4::handleInput(Event e, RenderWindow& window){
    if(GameOver){
        return -1;
    }
...
void Level4::Draw(RenderWindow& window){
