#include "Level1.h"
Level1::Level1(string backgroundPath, int noOfZombies, int noOfWaves, int allowedPlants, int noOflanes, int allowedZombies):Level(backgroundPath, noOfZombies, noOfWaves, allowedPlants, true, noOflanes, allowedZombies){
...
int Level1::handleInput(Event e, RenderWindow& window){
